...
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='output-division', component_property='children'),
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        # use groupby to create relevant data for plotting
        average_sales = recession_data.groupby('Vehile_Type')['Automobile_Sales'].mean().reset_index()                           
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for plotting
        exp_rec= rescesion_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
        R_chart3 = dcc.Graph(
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        avr_vdata=yearly_data.groupby('Vehicle_Type')['Automobiles_Sales'].mean().reset_index()
        ...
        Y_chart4 = dcc.Graph(exp_data,values='Advertising_Expenditure',names='Vehicle_Type',title="Total Advertisement Expenditure by Type")
